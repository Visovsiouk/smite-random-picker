...
class GodPicturesFetch extends React.Component {
	...
	populateFromAppCurrent() {
		...
		var allgods = [
			...
			{ id: 100, name: 'Merlin', src: './images/god-icons/Merlin.png', porsrc: './images/god-portraits/Merlin.jpg', selsrc: './sound/select/Merlin.ogg', pantheon: 'Arthurian', godclass: 'Mage', isSelected: true, pictureClassName: "god-picture-div green" },
			{ id: 101, name: 'Jormungandr', src: './images/god-icons/Jormungandr.png', porsrc: './images/god-portraits/Jormungandr.jpg', selsrc: './sound/select/Jormungandr.ogg', pantheon: 'Norse', godclass: 'Guardian', isSelected: true, pictureClassName: "god-picture-div green" },
			{ id: 102, name: 'Set', src: './images/god-icons/Set.png', porsrc: './images/god-portraits/Set.jpg', selsrc: './sound/select/Set.ogg', pantheon: 'Egyptian', godclass: 'Assassin', isSelected: true, pictureClassName: "god-picture-div green" },
			{ id: 103, name: 'Horus', src: './images/god-icons/Horus.png', porsrc: './images/god-portraits/Horus.jpg', selsrc: './sound/select/Horus.ogg', pantheon: 'Egyptian', godclass: 'Warrior', isSelected: true, pictureClassName: "god-picture-div green" },
			{ id: 104, name: 'Olorun', src: './images/god-icons/Olorun.png', porsrc: './images/god-portraits/Olorun.jpg', selsrc: './sound/select/Olorun.ogg', pantheon: 'Yoruba', godclass: 'Mage', isSelected: true, pictureClassName: "god-picture-div green" },
			{ id: 105, name: 'Persephone', src: './images/god-icons/Persephone.png', porsrc: './images/god-portraits/Persephone.jpg', selsrc: './sound/select/Persephone.ogg', pantheon: 'Greek', godclass: 'Mage', isSelected: true, pictureClassName: "god-picture-div green" },
			{ id: 106, name: 'Yemoja', src: './images/god-icons/Yemoja.png', porsrc: './images/god-portraits/Yemoja.jpg', selsrc: './sound/select/Yemoja.ogg', pantheon: 'Yoruba', godclass: 'Guardian', isSelected: true, pictureClassName: "god-picture-div green" },
		]
